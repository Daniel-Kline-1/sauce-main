      ...
      <Container >
        ...
        <Row>
          ...
          lg={6}>
              ...
              I also enjoy collaborating on teams. Two heads are always better than one.
        ...
        <Row>
          <Col sm={6}>
            ...
            From modal cars, model planes, to 3X3, 4X4, all the way up to 7X7 cube puzzles.
        ...
        <Row>
          <Col sm={6}>
            ...
            Matlab is good for analyzing data from lab experiments while MPLab is good for programing
            microcontrollers.
            </text>
          </Col>
        </Row>
        ...
        <Row>
          ...
          md={6}>
            <text>
              ...
              have a heat map to show where the locations with positive audio results 
              are. But we only had 24 hours to compleate the hackathon. 
              HERE is what was presented. HERE is where it is now</text>
            {/*
            {" "}
            <a href=''>
               HERE 
